 ...
 */
@Embeddable
public class SupplementsPK implements Serializable {
    @Column(name = "name")
    private String name;
    @Column(name = "epoch")
    ...
    public SupplementsPK() {
    }

    public SupplementsPK(String name, String epoch, String version, String release) {
        this.name = name;
        this.epoch = epoch;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SupplementsPK)) {
            return false;
        }
        SupplementsPK other = (SupplementsPK) object;
